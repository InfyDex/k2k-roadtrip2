...
export const REGIONS: TripRegion[] = [
  ...
  },
  {
    ...
    description:
      "Cruising down through Gujarat's heritage, the coastal charm of Daman, the electric energy of Mumbai, and into the paradise beaches of Goa. Four days of sun, surf, and stories.",
    bgColor: "#D4A574",
    textColor: "#1A1008",
    accentColor: "#8B4513",
    image: "",
    stops: [
      ...
      { day: 13, place: "Goa", state: "Goa", region: "west", lat: 15.2993, lng: 74.124 },
    ],
    stats: [
      { label: "Days", value: "8" },
      { label: "States", value: "4" },
  ...
  },
  {
    ...
    stops: [
      ...
      { day: 16, place: "Alappuzha", state: "Kerala", region: "south", lat: 9.4981, lng: 76.3388 },
      { day: 17, place: "Alappuzha", state: "Kerala", region: "south", lat: 9.4981, lng: 76.3388 },
  ...
  },
  {
    ...
    stops: [
      ...
      { day: 22, place: "Rameshwaram", state: "Tamil Nadu", region: "east", lat: 9.2876, lng: 79.3129 },
      { day: 23, place: "Thanjavur", state: "Tamil Nadu", region: "east", lat: 10.787, lng: 79.1378 },
      { day: 24, place: "Puducherry", state: "Puducherry", region: "east", lat: 11.9416, lng: 79.8083 },
      { day: 25, place: "Chennai", state: "Tamil Nadu", region: "east", lat: 13.0827, lng: 80.2707 },
      { day: 26, place: "Chennai", state: "Tamil Nadu", region: "east", lat: 13.0827, lng: 80.2707 },
      { day: 27, place: "Vijayawada", state: "Andhra Pradesh", region: "east", lat: 16.5062, lng: 80.648 },
      { day: 28, place: "Visakhapatnam", state: "Andhra Pradesh", region: "east", lat: 17.6868, lng: 83.2185 },
      { day: 29, place: "Visakhapatnam", state: "Andhra Pradesh", region: "east", notes: "Araku Valley", lat: 17.6868, lng: 83.2185 },
      { day: 30, place: "Brahmapur", state: "Odisha", region: "east", notes: "Maybe Puri", lat: 19.3115, lng: 84.7941 },
      { day: 31, place: "Cuttack", state: "Odisha", region: "east", lat: 20.4625, lng: 85.883 },
    ],
    stats: [
      { label: "Days", value: "11" },
      { label: "States", value: "4" },
  ...
  },
  {
    ...
    stops: [
      ...
      { day: 34, place: "Kolkata", state: "West Bengal", region: "return", lat: 22.5726, lng: 88.3639 },
      { day: 35, place: "Dhanbad", state: "Jharkhand", region: "return", lat: 23.7957, lng: 86.4304 },
      { day: 36, place: "Varanasi", state: "UP", region: "return", lat: 25.3176, lng: 82.9739 },
      { day: 37, place: "Lucknow", state: "UP", region: "return", lat: 26.8467, lng: 80.9462 },
      { day: 38, place: "Delhi", state: "Delhi", region: "return", lat: 28.6139, lng: 77.209 },
    ],
    stats: [
      { label: "Days", value: "7" },
      { label: "States", value: "4" },
